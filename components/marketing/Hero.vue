    ...
    <div class="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8">
      <div class="space-y-5 max-w-4xl mx-auto text-center">
        ...
        <h2 class="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
          Increase Your Vending Management Efficiency with <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]">VendTrakVMS</span>
        </h2>
        <p class="max-w-2xl mx-auto">
          Built from the Ground up with Vending Machine Owners in mind.
        </p>
        <div class="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
          <a href="javascript:void(0)" class="block py-2 px-4 text-white font-meddium bg-indigo-600 duration-150 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg shadow-lg hover:shadow-none">
            Get Started
          </a>
